 ...
 * Contiene los elementos y acciones necesarias para crear una nueva cuenta en la aplicación.
 */
public class RegisterPage extends BasePage {

    // Localizadores de elementos del formulario de registro
    ...
    // Acciones del usuario en la página de registro
    ...
    // Validación del registro exitoso
