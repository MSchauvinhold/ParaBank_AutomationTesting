 ...
 * Contiene los elementos y acciones necesarios para visualizar los datos de una cuenta específica,
 * consultar el balance disponible y filtrar movimientos por periodo o tipo de transacción.
 */

public class DetallePage extends BasePage {

    // Localizadores de elementos de la página de detalle de cuenta
    ...
    // Acciones sobre el formulario de login
